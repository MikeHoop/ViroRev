...
orf_file <- argv[1] # id in for loop
#orf_file <- './data/Closteroviridae/ORF/NC_001598.1.orfs'
taskID <- argv[2] # ./data/Closteroviridae
#taskID <- './data/Closteroviridae'
